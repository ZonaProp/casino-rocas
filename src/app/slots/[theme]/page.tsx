...
const THEMES: Record<
  string,
  { name: string; symbols: string[]; paytable: Record<string, number>; color: string }
> = {
  classic: {
    name: "Clásica",
    symbols: ["🍒", "🍋", "🍊", "🍇", "🔔", "⭐", "7️⃣", "💎"],
    paytable: { "💎💎💎": 50, "7️⃣7️⃣7️⃣": 30, "⭐⭐⭐": 20, "🔔🔔🔔": 15, "🍇🍇🍇": 10, "🍒🍒🍒": 5 },
    color: "#e63946",
  },
  egypt: {
    name: "Egipto",
    symbols: ["🔺", "👁️", "🏺", "🐍", "📜", "🪙", "👑", "💎"],
    paytable: { "💎💎💎": 60, "👑👑👑": 40, "🪙🪙🪙": 25, "📜📜📜": 15, "🐍🐍🐍": 10, "🔺🔺🔺": 5 },
    color: "#e8c547",
  },
  space: {
    name: "Espacial",
    symbols: ["🚀", "🪐", "⭐", "🌑", "👽", "🛸", "💫", "💎"],
    paytable: { "💎💎💎": 55, "🛸🛸🛸": 35, "💫💫💫": 20, "👽👽👽": 15, "🪐🪐🪐": 10, "🚀🚀🚀": 5 },
    color: "#8b5cf6",
  },
  ocean: {
    name: "Océano",
    symbols: ["🐠", "🐡", "🐙", "🐚", "⚓", "🌊", "💎", "🏆"],
    paytable: { "🏆🏆🏆": 50, "💎💎💎": 35, "🌊🌊🌊": 20, "⚓⚓⚓": 15, "🐚🐚🐚": 10, "🐠🐠🐠": 5 },
    color: "#06b6d4",
  },
  fortune: {
    name: "Fortuna",
    symbols: ["💎", "🔔", "⭐", "🍀", "💰", "🪙", "👑", "7️⃣"],
    paytable: { "7️⃣7️⃣7️⃣": 60, "👑👑👑": 40, "💰💰💰": 25, "🪙🪙🪙": 15, "🍀🍀🍀": 10, "💎💎💎": 5 },
    color: "#10b981",
  },
  fire: {
    name: "Fuego",
    symbols: ["🔥", "🌋", "☄️", "⚡", "💥", "🔶", "⭐", "💎"],
    paytable: { "💎💎💎": 55, "💥💥💥": 35, "⚡⚡⚡": 20, "☄️☄️☄️": 15, "🌋🌋🌋": 10, "🔥🔥🔥": 5 },
    color: "#f97316",
  },
  jungle: {
    name: "Jungla",
    symbols: ["🦁", "🐯", "🐵", "🦜", "🌴", "🍌", "💎", "👑"],
    paytable: { "👑👑👑": 50, "💎💎💎": 35, "🦁🦁🦁": 25, "🐯🐯🐯": 15, "🐵🐵🐵": 10, "🍌🍌🍌": 5 },
    color: "#22c55e",
  },
  pirate: {
    name: "Pirata",
    symbols: ["🏴‍☠️", "⚔️", "🦜", "🗺️", "⚓", "🪙", "💎", "🏆"],
    paytable: { "🏆🏆🏆": 55, "💎💎💎": 35, "🪙🪙🪙": 20, "🗺️🗺️🗺️": 15, "⚔️⚔️⚔️": 10, "🏴‍☠️🏴‍☠️🏴‍☠️": 5 },
    color: "#d97706",
  },
  candy: {
    name: "Dulce",
    symbols: ["🍬", "🍭", "🍫", "🧁", "🍩", "⭐", "💎", "👑"],
    paytable: { "👑👑👑": 50, "💎💎💎": 30, "⭐⭐⭐": 20, "🍩🍩🍩": 15, "🍭🍭🍭": 10, "🍬🍬🍬": 5 },
    color: "#ec4899",
  },
  vegas: {
    name: "Vegas",
    symbols: ["🎲", "🃏", "💰", "7️⃣", "🔔", "⭐", "💎", "👑"],
    paytable: { "👑👑👑": 60, "💎💎💎": 40, "7️⃣7️⃣7️⃣": 25, "💰💰💰": 15, "🔔🔔🔔": 10, "🎲🎲🎲": 5 },
    color: "#f43f5e",
  },
  norse: {
    name: "Nórdico",
    symbols: ["⚡", "🛡️", "⚔️", "🪓", "🧊", "🐺", "💎", "👑"],
    paytable: { "👑👑👑": 55, "💎💎💎": 35, "⚡⚡⚡": 25, "🐺🐺🐺": 15, "⚔️⚔️⚔️": 10, "🛡️🛡️🛡️": 5 },
    color: "#38bdf8",
  },
  japan: {
    name: "Japón",
  ...
  maya: {
    name: "Maya",
    symbols: ["🗿", "🗿", "🐍", "☀️", "🪙", "📜", "💎", "👑"],
    paytable: { "👑👑👑": 55, "💎💎💎": 35, "☀️☀️☀️": 20, "🐍🐍🐍": 15, "🪙🪙🪙": 10, "🗿🗿🗿": 5 },
    color: "#a16207",
  },
  cyber: {
    name: "Cyber",
  ...
  gold: {
    name: "Oro",
    symbols: ["👑", "🪙", "💰", "💎", "⭐", "🔔", "7️⃣", "🏆"],
    paytable: { "🏆🏆🏆": 60, "7️⃣7️⃣7️⃣": 40, "💎💎💎": 25, "💰💰💰": 15, "🪙🪙🪙": 10, "👑👑👑": 5 },
    color: "#eab308",
  },
  ice: {
    name: "Hielo",
    symbols: ["❄️", "🧊", "🐧", "⛄", "🌨️", "⭐", "💎", "👑"],
    paytable: { "👑👑👑": 50, "💎💎💎": 35, "❄️❄️❄️": 20, "🧊🧊🧊": 15, "🐧🐧🐧": 10, "⛄⛄⛄": 5 },
    color: "#38bdf8",
  },
  dragon: {
    name: "Dragón",
  ...
  mystic: {
    name: "Místico",
    symbols: ["🔮", "🌙", "✨", "🕯️", "📜", "⭐", "💎", "👑"],
    paytable: { "👑👑👑": 55, "💎💎💎": 35, "✨✨✨": 25, "🔮🔮🔮": 15, "🌙🌙🌙": 10, "🕯️🕯️🕯️": 5 },
    color: "#8b5cf6",
  },
  safari: {
    name: "Safari",
  ...
  galaxy: {
    name: "Galaxia",
    symbols: ["🌌", "🪐", "☄️", "🌟", "👽", "⭐", "💎", "👑"],
    paytable: { "👑👑👑": 55, "💎💎💎": 35, "🌟🌟🌟": 25, "🪐🪐🪐": 15, "☄️☄️☄️": 10, "🌌🌌🌌": 5 },
    color: "#7c3aed",
  },
  carnival: {
    name: "Carnaval",
    ...
    <div className="min-h-screen pb-16">
      ...
      <main className="mx-auto max-w-md px-4 py-5">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {[50, 100, 250, 500, 1000].map((b) => (
              <button
                ...
                onClick={() => setBet(b)}
                disabled={spinning}
                className={`rounded-lg px-3 py-1.5 text-sm font-medium ${bet === b ? "text-black" : "bg-[#1a150f] text-zinc-300"}`}
        ...
        <div className="mt-6 rounded-xl border border-[#2a241c] bg-[#16120e] p-3 text-xs text-zinc-400">
          <p className="mb-1.5 font-medium text-zinc-300">Premios principales</p>
          <div className="grid grid-cols-2 gap-1">
            {Object.entries(theme.paytable).slice(0, 6).map(([k, v]) => (
              <span key={k}>{k} → x{v}</span>
            ))}
          </div>
        </div>
      </main>
